...
This minor release includes deprecation of Ansible Turbo mode (``ENABLE_TURBO_MODE``), bugfixes for the ``helm``, ``helm_template``, and ``k8s`` lookup plugins to support ansible-core 2.19.0 and Helm 4.2.1, and improvements to the ``k8s_cp`` module.
